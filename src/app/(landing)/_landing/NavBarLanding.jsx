      ...
      >
        <nav className="flex items-center justify-between container mx-auto py-2">
          <div className="flex flex-col sm:flex-row gap-1 sm:gap-5 items-center justify-center">
            <Link
              href={"/"}
              className="relative flex gap-1 sm:gap-2 items-center justify-center w-[100px] h-[60px]"
            >
              <Image
                src={"/mhlogopng.png"}
                alt={"logo"}
          ...
          <div className="hidden md:flex flex-col lg:flex-row gap-1 space-x-6 text-sm">
            ...
            <Link
              ...
              className="cursor-pointer group relative flex gap-1.5 px-8 py-4 bg-blue-700/90 text-white rounded-3xl hover:bg-opacity-70 transition shadow-md"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
        ...
        <div className="bg-black text-white">
          <div className="container mx-auto hidden sm:flex justify-between items-center py-2">
            ...
            <div className="relative flex justify-center items-center">
              ...
              />
              <svg
                className="size-6 absolute top-3 right-3 text-white"
                stroke="currentColor"
                strokeWidth="1.5"
                viewBox="0 0 24 24"
                fill="none"
